...
class GraphAL:
    ...
    def __init__(self, vertices, directed):
        ...
        self.nvertices = vertices  # Number of vertices
        self.nedges = 0  # Number of edges
        self.directed = directed  # Directed graph indicator
        self.edges = [None] * (self.max_vertices + 1)  # Adjacency list (1-based indexing)
        self.degree = [0] * (self.max_vertices + 1)  # Degree of each vertex
    ...
    def dijkstra(self, start):
        ...
        distance = [sys.maxsize] * (self.max_vertices + 1)  # Shortest known distance to each vertex
